...
public class MaterialDialog {
    ...
    protected final static int BUTTON_BOTTOM = 9;
    protected final static int BUTTON_TOP = 9;
    ...
    protected View mMessageContentView;
    ...
    public MaterialDialog setView(View view) {
        mView = view;
        if (mBuilder != null) {
            mBuilder.setBackgroundResource(R.drawable.transparent);
...
//7
        ...
        public void setView(View view) {
            ...
            l.removeAllViews();
            l.setBackgroundColor(mContext.getResources().getColor(android.R.color.transparent));
